class App:
    ...
    def name(self, value: str):
        ...
        if len(value.strip()) == 0: # проверяем, что строка не пустая после удаления пробелов
    ...
    def author(self):
        ...
        Возвращает:
        Author -- автор приложения (экземпляр класса Author)
        '''
    ...
    def __repr__(self):
        ...
        Возвращает:
        str -- строковое представление в формате: App(name='...', version='...', author=...)
        '''
